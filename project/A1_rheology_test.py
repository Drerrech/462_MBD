...
mbd.mbd_v2(A1_rheology.rheology_4_element_wise, x_0, models.gen_simplex_grad_sum_of_models, line_search.quadratic_interpolation_line_search, log_path="project/logs/rheology/testing_random_descent/v2_sum_I_q_375_plain.txt", f_post_process=A1_rheology.rheology_post_processing, max_f_evals=375)
